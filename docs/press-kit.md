...
- [Main scan screen](screenshots/scan-desktop-1440x900.png)
- [Detection rules](screenshots/settings-rules-1440x900.png)
- [Cloak List editor](screenshots/cloak-list-editor-1440x900.png)

All screenshots use synthetic data.

## Main points

- Scans text locally with no account, backend, telemetry, or content upload.
- Detects common API keys, credentials, network details, personal data, file paths, and work-specific terms.
- Shows each replacement before the cleaned text is copied.
- Supports one-time custom terms, reusable Cloak Lists, profiles, country packs, and custom labeled fields.
- Runs as a Windows installer, Linux `.deb`, Linux AppImage, or browser demo.
...
- Category: Privacy, security, developer tools, utilities
